...
public class BackPasswordTimeButton extends Button implements OnClickListener {
	...
	public BackPasswordTimeButton(Context context) {
		super(context);
		setOnClickListener(this);

	}

	public BackPasswordTimeButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		setOnClickListener(this);
	}
	...
	Handler han = new Handler() {
		public void handleMessage(android.os.Message msg) {
			BackPasswordTimeButton.this.setText(textafter+"("+time / 1000 +")");
			BackPasswordTimeButton.this.setTextColor(Color.parseColor("#999999"));
			time -= 1000;
			if (time < 0) {
				BackPasswordTimeButton.this.setEnabled(true);
				BackPasswordTimeButton.this.setText(textbefore);
				BackPasswordTimeButton.this.setTextColor(Color.parseColor("#e8a12e"));
				clearTimer();
			}
		};
	};
	...
	public void setOnClickListener(OnClickListener l) {
		if (l instanceof BackPasswordTimeButton) {
	...
	public void onClick(final View v) {
		String phoneNo=BackPasswordActivity.ed_backpwd_phone.getText().toString();
		...
		}else if(!BackPasswordActivity.isValid){
	...
	/** * 设置计时时候显示的文本 */
	public BackPasswordTimeButton setTextAfter(String text1) {
		this.textafter = text1;
		return this;
	}

	/** * 设置点击之前的文本 */
	public BackPasswordTimeButton setTextBefore(String text0) {
	 ...
	 * @return
	 */
	public BackPasswordTimeButton setLenght(long lenght) {
		this.lenght = lenght;
		return this;
	}
}