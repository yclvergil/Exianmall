...
public class ImageCycleView extends LinearLayout {
	 ...
	 * 图片轮播视图
	 */
	private 	MyViewPage mAdvPager = null;
	/**
	 * 滚动图片视图适配
	 */
	...
	public ImageCycleView(Context context, AttributeSet attrs) {
		...
		mAdvPager = (MyViewPage) findViewById(R.id.adv_pager);
		...
		mAdvPager.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				case MotionEvent.ACTION_UP:
					...
					intent2.setAction(MainActivity.canopen_cehua);
					intent2.putExtra("isture", "canmove");
					mContext.sendBroadcast(intent2);
					// 开始图片滚动
					startImageTimerTask();
//					LogUtils.e("ACTION_UPACTION_UP");
					break;
				default:
					// 停止图片滚动
					stopImageTimerTask();
	...
	public void setImageResources(ArrayList<String> imageUrlList,
		...
		for (int i = 0; i < imageCount; i++) {
			...
			if (i == 0) {
				mImageViews[i]
						.setBackgroundResource(R.drawable.banner_point_on);
			} else {
				mImageViews[i]
						.setBackgroundResource(R.drawable.banner_point_normal);
			}
