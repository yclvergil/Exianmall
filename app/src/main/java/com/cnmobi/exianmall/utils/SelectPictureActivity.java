...
public class SelectPictureActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initView();
		bitmapUtils = new BitmapUtils(SelectPictureActivity.this);
	}
	...
	private void initView() {
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				titlename = currentImageFolder.getName().substring(1);
				btn_select.setText(titlename + "\n" + selectedPicture.size() + "/" + MAX_NUM);
			}
		});
		getThumbnail();
	}
	...
	class PictureAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (position == 0) {
				...
				bitmapUtils.display(holder.iv, "file://" + item.path);
	...
	class FolderAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			bitmapUtils.display(holder.id_dir_item_image, "file://" + item.getFirstImagePath());
			holder.id_dir_item_count.setText(item.images.size() + "");
			holder.id_dir_item_name.setText(item.getName().substring(1));
	...
	private void getThumbnail() {
		Cursor mCursor = mContentResolver.query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI,
				new String[] { MediaStore.Images.ImageColumns.DATA }, "", null, MediaStore.MediaColumns.DATE_ADDED
						+ " DESC");
