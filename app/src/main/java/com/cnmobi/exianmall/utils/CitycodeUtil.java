...
public class CitycodeUtil {
	...
	public ArrayList<String> getProvince(List<CityInfoBean> provice) {
	...
	public ArrayList<String> getCity(
			HashMap<String, List<CityInfoBean>> cityHashMap, String provicecode) {
		...
		List<CityInfoBean> city = new ArrayList<CityInfoBean>();
	...
	public ArrayList<String> getCouny(
			HashMap<String, List<CityInfoBean>> cityHashMap, String citycode) {
		System.out.println("citycode" + citycode);
		List<CityInfoBean> couny = null;
		...
		if (couny == null) {
			couny = new ArrayList<CityInfoBean>();
		} else {
			couny.clear();
		}
